...
class APIs {
  ...
  static Future<bool> userExists() async {
    return (await firestore.collection('users').doc(user_uid).get()).exists;
  }
  ...
  static Future<bool> addChatUser(String email) async {
    ...
    if (data.docs.isNotEmpty && data.docs.first.id != user_uid) {
      //user exists
  ...
  static Future<void> updateActiveStatus(bool isOnline) async {
    firestore.collection('users').doc(user_uid).update({
      'is_online': isOnline,
