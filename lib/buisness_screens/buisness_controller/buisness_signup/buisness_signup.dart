...
class _BuisnessSignUpState extends State<BuisnessSignUp> {
  ...
  BuisnessSignUpController businessStateController = Get.put(BuisnessSignUpController());
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Obx(
                      () => CustumTextField(
                        keyboardType: TextInputType.emailAddress,
                        onTap: () {
                          buisbnesssignUpController.seePassword.value = !buisbnesssignUpController.seePassword.value;
                        },
                        controller: buisbnesssignUpController.bpasswordcontroller,
                        validator: validatePassword,
                        suffixIconn: buisbnesssignUpController.seePassword == true ? 'assets/icons/Eye Slash.svg' : 'assets/icons/eye.svg',
                        hintText: 'Password',
                        obscureText: buisbnesssignUpController.seePassword.value,
                      ),
                    ),
                    ...
                    Obx(
                      () => CustumTextField(
                        onTap: () {
                          buisbnesssignUpController.seePassword1.value = !buisbnesssignUpController.seePassword1.value;
                        },
                        controller: buisbnesssignUpController.bconfirmpasscontroller,
                        validator: validateConfPassword,
                        keyboardType: TextInputType.emailAddress,
                        suffixIconn: buisbnesssignUpController.seePassword1 == true ? 'assets/icons/Eye Slash.svg' : 'assets/icons/eye.svg',
                        hintText: 'Confirm Password',
                        obscureText: buisbnesssignUpController.seePassword1.value,
                      ),
                    ),
                    const SizedBox(
                      height: 15,
                          ...
                          suffixIcon: InkWell(
                              ...
                              child: Obx(() => buisbnesssignUpController.loadAddress.value
                                  ? Container(
                                      ...
                                      child: const CircularProgressIndicator(color: Colors.white, strokeWidth: 3.0),
                                    )
                                  : const Icon(
                                      Icons.location_disabled,
                                      color: Colors.white,
                                    ))),
                          hintText: buisbnesssignUpController.currentAddress != null ? buisbnesssignUpController.currentAddress.toString() : "Address",
                    ...
                    CSCPicker(
                      ...
                      onCountryChanged: (value) {
                        setState(() {
                          ...
                          value = buisbnesssignUpController.countryValue.toString();
                        });
                      },
                      ...
                      onCityChanged: (value) {
                        setState(() {
                          ...
                          buisbnesssignUpController.cityValue = value.toString();
                        });
                      },
