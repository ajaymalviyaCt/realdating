...
class _BuisnessHomePageState extends State<BuisnessHomePage> {
  ...
  void uploadFileToServerBHome(post, miniblog, postType) async {
    ...
    try {
      ...
      var request = http.MultipartRequest(
          "POST", Uri.parse("https://forreal.net:4000/create_business_post"));
      final headers = {
                      ...
                      child: Obx(
                          ...
                          child: ClipRRect(
                            ...
                            child: CachedNetworkImage(
                              imageUrl: profileController.bussinessProfilepic
                                  .toString(),
                              placeholder: (context, url) => const Center(
                                  child: SizedBox(
                                      height: 20,
  ...
  topDealsList(MyDealController controller) {
    ...
    return controller.myDealsModel?.myDeals.length == 0 ||
            controller.myDealsModel?.myDeals.length == null
        ? Center(
            child: Container(
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    String result = '';
                    int value1 = int.tryParse(controller
                            .myDealsModel!.myDeals[index].price
                            .toString()) ??
                        0;
                    int value2 = int.tryParse(controller
