                ...
                child: myDealController.myDealsModel?.myDeals.length == null
                    ...
                    : GridView.builder(
                        ...
                        gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                            crossAxisCount: 2, childAspectRatio: 20 / 28, crossAxisSpacing: 4.0, mainAxisSpacing: 8.0),
                        itemCount: myDealController.myDealsModel?.myDeals.length,
                        itemBuilder: (BuildContext context, int index) {
                          String result = '';
                          int value1 = int.tryParse(myDealController.myDealsModel!.myDeals[index].price.toString()) ?? 0;
                          int value2 = int.tryParse(myDealController.myDealsModel!.myDeals[index].discount.toString()) ?? 0;
