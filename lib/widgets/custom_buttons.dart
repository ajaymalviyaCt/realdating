...
class PrimaryBtn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return loading??false ? ElevatedButton(
      onPressed: (){},
...
class PrimaryBtn2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return loading??false ? Container(
      ...
      onPressed: btnFun,
      style:getBtnStyle(context) ,
      child: textBold("$btnText",context,14.sp,Colors.black,),
    );
  }
  getBtnStyle(context) => ElevatedButton.styleFrom(
    side:  BorderSide(
...
class customPrimaryBtn2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return loading??false ? ElevatedButton(
      onPressed: btnFun,
      style:getBtnStyle(context) ,
      child: customTextCommon( text: '$btnText', fSize: 17, fWeight: FontWeight.w600, lineHeight: 17,),
    ) : ElevatedButton(
      onPressed: btnFun,
      style:getBtnStyle(context) ,
      child: customTextCommon( text: '$btnText', fSize: 17, fWeight: FontWeight.w600, lineHeight: 17,),
...
class customPrimaryBtn extends StatelessWidget {
  const customPrimaryBtn({Key? key ,
...
class customPrimaryBtnBlk extends StatelessWidget {
  const customPrimaryBtnBlk({Key? key ,
    required this.btnText ,
    required this.btnFun,
    this.btnclr,
    this.btntextclr,
