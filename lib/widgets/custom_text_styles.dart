...
Text textBold(
  ...
  return Text(
    ...
    style: TextStyle(fontSize: fSize, fontFamily: "bold", color: tcolor ?? colors.white, letterSpacing: .78),
  );
}
...
Text textsemiBold(
  ...
  return Text(
    data,
    style: TextStyle(fontSize: fSize ?? 14, fontFamily: "sbold", color: tcolor ?? colors.white, letterSpacing: .78),
  );
}
...
Text textMedium(
  ...
  return Text(
    data,
    textAlign: TextAlign.center,
    style: TextStyle(fontSize: fSize, fontFamily: "medium", color: tcolor ?? colors.white, letterSpacing: .58),
  );
}
