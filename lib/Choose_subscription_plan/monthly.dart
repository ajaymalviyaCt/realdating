      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            SvgPicture.asset("assets/images/daimond.svg",height: 100,),
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: Text('Yearly',
                                style: TextStyle(fontSize: 14.fSize,fontWeight: FontWeight.w500,
                                    fontFamily: 'Roboto',color: Colors.black,height: 1.5
                                ),
                              ),
                            ),
                          ),
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text('25 set number of Real Reveals per month',
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Center(
                            child: Text('Yearly',
                              style: TextStyle(fontSize: 14.fSize,fontWeight: FontWeight.w500,
                                  fontFamily: 'Roboto',color: Colors.white,height: 1.5
                              ),
                            ),
                          ),
                        ),
                                ...
                                Center(
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(width: 3.aw),
                                      Text('(16%off)',
                                        style: TextStyle(fontSize: 9.fSize,fontWeight: FontWeight.w500,
