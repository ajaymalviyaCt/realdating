...
class Heading1Text extends StatelessWidget {
  ...
  const Heading1Text(this.text, {super.key, this.textAlign, this.maxLines, this.weight, this.color});
...
class Heading2Text extends StatelessWidget {
  ...
  const Heading2Text(this.text, {super.key, this.textAlign, this.maxLines, this.weight, this.color});
...
class Heading3Text extends StatelessWidget {
  ...
  const Heading3Text(this.text, {super.key, this.textAlign, this.maxLines, this.weight, this.color});
...
class Heading4Text extends StatelessWidget {
  ...
  const Heading4Text(this.text, {super.key, this.textAlign, this.maxLines, this.weight, this.color});
...
class Heading5Text extends StatelessWidget {
  ...
  const Heading5Text(this.text, {super.key, this.textAlign, this.maxLines, this.weight, this.color});
...
class Heading6Text extends StatelessWidget {
  ...
  const Heading6Text(this.text, {super.key, this.textAlign, this.maxLines, this.weight, this.color});
...
class BodyExtraLargeText extends StatelessWidget {
  ...
  const BodyExtraLargeText(this.text, {super.key, this.textAlign, this.maxLines, this.weight, this.color});
...
class BodyLargeText extends StatelessWidget {
  ...
  const BodyLargeText(this.text, {super.key, this.textAlign, this.maxLines, this.weight, this.color});
...
class BodyMediumText extends StatelessWidget {
  ...
  const BodyMediumText(this.text, {super.key, this.textAlign, this.maxLines, this.weight, this.color});
...
class BodySmallText extends StatelessWidget {
  ...
  const BodySmallText(this.text, {super.key, this.textAlign, this.maxLines, this.weight, this.color});
...
class BodyExtraSmallText extends StatelessWidget {
  ...
  const BodyExtraSmallText(this.text, {super.key, this.textAlign, this.maxLines, this.weight, this.color});
