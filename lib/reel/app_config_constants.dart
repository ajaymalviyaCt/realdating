...
class AppColorConstants {
  ...
  static Color get backgroundColor => isDarkMode ? HexColor.fromHex('202020') : HexColor.fromHex('FFFFFF');

  static Color get cardColor => isDarkMode ? HexColor.fromHex('202020').lighten(0.05) : HexColor.fromHex('FFFFFF').darken(0.05);
  ...
  static Color get mainTextColor => isDarkMode ? Colors.white : Colors.black;

  static Color get subHeadingTextColor => isDarkMode ? const Color(0xFF34495e) : const Color(0xFF34495e);
}

class DatingProfileConstants {
  static List<String> genders = ['Male', 'Female', 'Other'];
  static List<String> colors = ['Black', 'White', 'Brown'];
  static List<String> religions = ['Christians', 'Muslims', 'Hindus', 'Buddhists', 'Sikhs', 'Jainism', 'Judaism'];
