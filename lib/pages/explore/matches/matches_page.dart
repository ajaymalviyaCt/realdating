...
class _MatchesPageState extends State<MatchesPage> {
    ...
    if (picked != null && picked != _selectedTime) {
      setState(() {
        ...
        String militaryTimeString =
            "${picked.hour}:${picked.minute.toString()}"; // Your 24-hour format time string
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Obx(() => matchessController.isLoadig.value? Center(child: const CircularProgressIndicator(strokeWidth: 2,)) :  matchessController.matchessModel!.myFriends!.isEmpty ? SizedBox( height: MediaQuery.of(context).size.height-200,
            ...
            itemBuilder: (BuildContext context, int index) {
              return InkWell(
                onTap: () {
                  Get.to(
                        () => MatchDetails(
                      id: matchessController.matchessModel!.myFriends![index].friendId.toString(), isfriend: true,
                    ),
                  );
                },
                child: Padding(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('${matchessController.matchessModel!.myFriends![index].friendFirstName} ${matchessController.matchessModel!.myFriends![index].friendLastName}',
                                  style: TextStyle(
                                    color: Colors.white,
