            ...
            () => myAllDatesController.isLoading.value
                ...
                : Expanded(
                    child: RefreshIndicator(
                      ...
                      child: myAllDatesController.myAllDatesModel?.myInvites?.length != 0
                          ? ListView.builder(
                                                ...
                                                Row(
                                                  children: [
                                                    InkWell(
                                                      ...
                                                      child: CircleAvatar(
                                                        backgroundImage: const AssetImage("assets/icons/profile.svg"),
                                                        child: Container(
                                                          width: 50,
                                                          height: 50,
                                                          decoration: ShapeDecoration(
                                                        ...
                                                        if (myAllDatesController.myAllDatesModel?.myInvites?[index].requestStatus == 'Received') {
                                                          ...
                                                          return Row(
                                                            children: [
                                                              ...
                                                              7.widthBox,
                                                              "Requested".text.base.medium.make(),
                                                            ],
                                                          );
                                                        }
        ...
        builder: (_) => AlertDialog(
              ...
              actions: [
                ...
                MaterialButton(
                    ...
                    child: Text('Cancel', style: TextStyle(color: Colors.blue, fontSize: 15.adaptSize))),
                ...
                MaterialButton(
                    ...
                    child: Text(
                      'Add',
                      style: TextStyle(color: Colors.blue, fontSize: 15.adaptSize),
                    ))
              ],
            ));
  }
