...
class _EventDetailsState extends State<EventDetails> {
  EventsDetailsController eventsDetailsController = Get.put(EventsDetailsController());
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        width: 341.w,
                        child: Text(
                          eventsDetailsController.eventsDetailsModel?.getEvent[0].description ??
                              'Tired of swiping and texting? Come, join us at our social mixer to meet potential dates and friends online.',
                          style: const TextStyle(
                            color: Color(0xFF111111),
                            fontSize: 14,
                            fontFamily: 'Inter',
