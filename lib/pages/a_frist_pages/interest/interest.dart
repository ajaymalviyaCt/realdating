...
class _Interest_ScreenState extends State<Interest_Screen> {
  ...
  List<String> InterestS = ["Gaming,","Dancing,","Language,","Music,","Movie,","Photography,","Fashion,","Architecture,","Book,","Writing,","Animals,","Football,",'Gym & Fitness,','Travel & Places,',];
  List<String> AllInters = ["Gaming,","Dancing,","Language,","Music,","Movie,","Photography,","Fashion,","Architecture,","Book,","Writing,","Animals,","Football,",'Gym & Fitness,','Travel & Places,',];
        ...
        child: Column(
          children: [
            const Padding(
              ...
              child: Text('Select your interests to match with users who '
                  '\n have similar things in common.',style: CustomTextStyle.blacky,),
            ),
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Text('💃🏻 Dancing',style:  TextStyle(color: active[1] ? Colors.red : Colors.white,fontSize: 18),)),
                  ),
                )
              ],
            ),
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Text('🗣 Language',style: TextStyle(color: active[2] ? Colors.red : Colors.white,fontSize: 18),)),
                  ),
                ),
                InkWell(
                    onTap: (){
                    ...
                    child: Container(
                      ...
                      child: Center(child: Text('🎵 Music',style: TextStyle(color: active[3] ? Colors.red : Colors.white,fontSize: 18),)),
                    )
                )
              ...
              children: [
                InkWell(
                  ...
                  Container(
                    ...
                    child: Center(child: Text('🎬 Movie',style: TextStyle(color: active[4] ? Colors.red : Colors.white,fontSize: 18),)),
                  ),
                ),
                InkWell(
                    onTap: (){
                    ...
                    child:Container(
                      ...
                      child: Center(child: Text('📸 Photography',style: TextStyle(color: active[5] ? Colors.red : Colors.white,fontSize: 18),)),
                    )
                )
              ],
            ),
              ...
              children: [
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Text('👗 Fashion',style: TextStyle(color: active[6] ? Colors.red : Colors.white,fontSize: 18),)),
                  ),
                ),
                ...
                InkWell(
                    ...
                    child: Container(
                      ...
                      child: Center(child: Text('🏛 Architecture',style: TextStyle(color: active[7] ? Colors.red : Colors.white,fontSize: 18),)),
                    )
                )
              ],
            ),
              ...
              children: [
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Text('📚 Book',style:TextStyle(color: active[8] ? Colors.red : Colors.white,fontSize: 18),)),
                  ),
                ),
              ...
              children: [
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Text('🐼 Animals',style: TextStyle(color: active[10] ? Colors.red : Colors.white,fontSize: 18),)),
                  ),
                ),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Text('⚽️ Football',style: TextStyle(color: active[11] ? Colors.red : Colors.white,fontSize: 18),)),
                  ),
                )
              ],
            ),
              ...
              children: [
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Text('💪 Gym & Fitness',style: TextStyle(color: active[12] ? Colors.red : Colors.white,fontSize: 18),)),
                  ),
                ),
                ...
                InkWell(
                    ...
                    child: Container(
                      ...
                      child: Center(child: Text('🌇 Travel & Places',style: TextStyle(color: active[13] ? Colors.red : Colors.white,fontSize: 14),)),
                    )
                )
              ],
            ),
           ...
           const SizedBox(height: 70,),
            customPrimaryBtn(btnText: "Continue", btnFun: (){
