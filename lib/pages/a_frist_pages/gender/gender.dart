                            ...
                            Center(
                              child: Text('Women                                                           ',
                                  style:TextStyle(
                                      ...
                                      color:gender1[0] ? Colors.white :  Colors.black )),
                            ),
                            gender1[0] ? SvgPicture.asset('assets/icons/click.svg',color: Colors.white,) :  SizedBox(width: .1,height: .1,) ,
                          ],
                        ),
                      ),
                    ),
                          ...
                          children: [
                            Center(
                              child: Text('Men                                                           ',
                                  style:TextStyle(
                                      fontSize:16,fontWeight: FontWeight.w400,fontFamily: 'Aboshi',
                                      color:gender1[1] ? Colors.white :  Colors.black )),
                            ),
                            gender1[1] ? SvgPicture.asset('assets/icons/click.svg',color: Colors.white,) :  SizedBox(width: .1,height: .1,) ,
                          ],
                        ),
                      ),
                    ),
                          ...
                          children: [
                            Center(
                              child: Text('Other                                                           ',
                                  style:TextStyle(
                                      fontSize:16,fontWeight: FontWeight.w400,fontFamily: 'Aboshi',
                                      color:gender1[2] ? Colors.white :  Colors.black )),
                            ),
                            gender1[2] ? SvgPicture.asset('assets/icons/click.svg',color: Colors.white,) :  SizedBox(width: .1,height: .1,) ,
                          ],
                        ),
                      ),
                    ),
