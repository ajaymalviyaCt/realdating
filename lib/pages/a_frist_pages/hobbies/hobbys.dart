      ...
      appBar: AppBar(
        leading:  InkWell(
          ...
          child: Padding(
            ...
            child: SvgPicture.asset('assets/icons/btn.svg',fit: BoxFit.contain,),
          ),
        ),
        title: const Text('Your Hobby',style: CustomTextStyle.black,),
        centerTitle: true,
      ),
        ...
        child: Column(
          children: [
            const Padding(
              ...
              child: Text('Select your hobby to match with users who '
