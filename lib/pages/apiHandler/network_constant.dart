...
class NetworkConstantsUtil {
  ...
  static String reelAudioCategories = 'get_audio_category';
  static String audios = 'audios?';

  // I/flutter (22489): fullurl https://product.fwdtechnology.co/socialified/api/web/v1/categories/reel-audio
  // I/flutter (22489): fullurl https://product.fwdtechnology.co/socialified/api/web/v1/audios?&category_id=15
  //***********chat***********//
