...
/////////////Buisness///////////
  ...
  static final Uri buisnesssignUp =
      Uri.parse('https://forreal.net:4000/signUp_business');

  static final Uri buisnesslogin =
      Uri.parse('https://forreal.net:4000/loginbusiness');
  ...
  static final Uri createdeal =
      Uri.parse('https://forreal.net:4000/create_deals');

  static final Uri buisnessprofile =
      Uri.parse('https://forreal.net:4000/myprofile');
  static final Uri buisnessKYCDocument =
      Uri.parse('https://forreal.net:4000/business_document_1');
  static final Uri buisnessKYCIdentificationUrl =
      Uri.parse('https://forreal.net:4000/business_document_camera');

  static final Uri buisnessAllPostHome =
      Uri.parse('https://forreal.net:4000/Get_all_business_post');

  /// Edit deal Url
  static final Uri editdealupdate =
      Uri.parse('https://forreal.net:4000/update_deals');
  static final Uri editdealdelete =
      Uri.parse('https://forreal.net:4000/delete_deals');
  ...
  static final Uri editadsupdate =
      Uri.parse('https://forreal.net:4000/update_advs');
  static final Uri adsdelete =
      Uri.parse('https://forreal.net:4000/delete_adv');

  /// post
  static final Uri postDelete =
      Uri.parse('https://forreal.net:4000/delete_business_post');
  static final Uri postDeleteUser = Uri.parse('https://forreal.net:4000/delete_post');
  static final Uri postLike =
      Uri.parse('https://forreal.net:4000/Like_business_post');
  static final Uri postLikeUser =
  Uri.parse('https://forreal.net:4000/Like_post');
  static final Uri postComment =
      Uri.parse('https://forreal.net:4000/comment_business_post');
  static final Uri userPostComment =
      Uri.parse('https://forreal.net:4000/comment_post');
  ...
  static final Uri businessAddCoverUrl =
      Uri.parse('https://forreal.net:4000/add_cover_photo');
  ...
  static final Uri supportUri =
  Uri.parse('https://forreal.net:4000/users/support');
}
