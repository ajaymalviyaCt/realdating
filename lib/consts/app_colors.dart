...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xffFA4B65);
  static const Color lightgreen = Color(0xff26FFDA);
...
//
// static const Color grad1Color = Color(0xff7c2525);
// static const Color grad2Color = Color(0xff7c2525);
